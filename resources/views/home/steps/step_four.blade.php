...
<div id="voyager" data-basename="/voyager/experience" class="flex-1 relative"><section id="voyager-blocks"><section><section class=""><div data-testid="progress-bar" class="_progressBar_63yfq_1"><div class="_progress_63yfq_1" style="width: 66.6667%;"></div></div>
    <a href="javascript:history.back()"><button data-testid="button-previous" type="button" class="_buttonPrevious_pmptr_34"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="_buttonChevron_pmptr_37" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="_notAnimated_pmptr_10"><span class="_headingContainer_1fpvz_1"><p>Awesome! Okay, now for some final details.</p><h2 class="_soloHeading_1fpvz_8">Tell us your name.</h2></span>
    
    <form method="POST" action="{{ route('steps.05') }}">
        @csrf    
        <div>
            <div data-testid="callout-field" class="_callout_1qfey_1"><p>This will only be shared with the <strong>schools that you choose.</strong></p></div></div>
            
            <div>
                <div class="_fieldGroup_1g3ja_1"><input id="firstName" class="_textField_fwd9c_1" name="first_name" placeholder="First Name" data-testid="firstname" value=""></div>
            </div>
                
                <div>
                    <div class="_fieldGroup_1g3ja_1"><input id="lastName" class="_textField_fwd9c_1" name="last_name" placeholder="Last Name" data-testid="lastname" value=""></div>
                </div>
  
    <div class="_pageActions_pmptr_26">
        <button type="submit" class="_buttonContinue_pmptr_46 _button_pmptr_30" data-testid="continue">
            <span>Continue</span><svg width="26" height="16" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M16.6774 0.468629C17.3023 -0.15621 18.3153 -0.15621 18.9402 0.468629L25.3402 6.86863C25.965 7.49347 25.965 8.50653 25.3402 9.13137L18.9402 15.5314C18.3153 16.1562 17.3023 16.1562 16.6774 15.5314C16.0526 14.9065 16.0526 13.8935 16.6774 13.2686L20.346 9.6H1.80879C0.925131 9.6 0.208786 8.88366 0.208786 8C0.208786 7.11634 0.925131 6.4 1.80879 6.4H20.346L16.6774 2.73137C16.0526 2.10653 16.0526 1.09347 16.6774 0.468629Z" fill="white"></path></svg>
            </button></div>
    </form>
    <p class="_disclaimer_icov9_1"><svg width="18" height="20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.024 8.8V6.4a6 6 0 0 1 12 0v2.4a2.4 2.4 0 0 1 2.4 2.4v6a2.4 2.4 0 0 1-2.4 2.4h-12a2.4 2.4 0 0 1-2.4-2.4v-6a2.4 2.4 0 0 1 2.4-2.4Zm9.6-2.4v2.4h-7.2V6.4a3.6 3.6 0 0 1 7.2 0Z" fill=" #e22944"></path></svg>We safeguard your information with 256-bit encryption, the same method employed by most banks and one of the most secure encryption solutions available.</p></div></section></section></section></div>
