        ...
        <div class="card-body p-0">
            <div class="options-inv">
                ...
                <div class="dropdown-menu dropdown-menu-start">
                    @if ($x->published)
                    <a class="dropdown-item" href={{ route("admin.unpublish",[ 'program_id' => $x->id]) }}><i class="fa fa-minus-circle me-2"></i> Unpublish</a>
                    @else
                    <a class="dropdown-item" href={{ route("admin.publish",[ 'program_id' => $x->id]) }}><i class="fa fa-upload me-2"></i> Publish</a>
                    @endif

                    <a class="dropdown-item" href={{ route("admin.edit-scholarship",[ 'program_id' => $x->id]) }}><i class="fa fa-pencil me-2"></i> Edit</a>
            ...
            <div class="d-flex align-items-center justify-content-between py-5 px-6 mt-2">
                ...
                <div>
                    <a href={{ route('user.scholarship', ['program_id' => $x->id]) }} class="btn btn-info">View</a>
                </div>
            </div>
            <hr class="mt-0 mb-0">
