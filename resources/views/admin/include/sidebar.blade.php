		...
		<div class="main-sidemenu">
			...
			<ul class="side-menu">
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						<li><a href={{ route('admin.create-scholarship') }} class="slide-item">New</a></li>
						<li><a href={{ route('admin.all-scholarships') }} class="slide-item">All</a></li>
						<li><a href={{ route('admin.published-scholarships') }} class="slide-item">Published</a></li>
						<li><a href={{ route('admin.unpublished-scholarships') }} class="slide-item">Unpublished</a></li>
					</ul>
				</li>
				<li>
					<h3>Pages</h3>
