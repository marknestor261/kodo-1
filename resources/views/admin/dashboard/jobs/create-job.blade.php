			...
			<div class="main-container container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
                        <form method="POST" action="{{ route('admin.create.job') }}">
                            @csrf
                            <div  class="card">
                                    ...
                                    <div class="row p-5 border-bottom">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            ...
                                            <!-- <div class="mb-3"> -->
											  ...
											  <textarea class="form-control " id="validationTextarea" placeholder="About this job" name="about" rows="15" required></textarea>
