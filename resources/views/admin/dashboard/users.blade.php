										...
										<div class="table-responsive">
											<table id="data-table" class="table text-nowrap mb-0 table-bordered">
												<thead class="table-head">
													<tr>
														<th class="bg-transparent border-bottom-0 wp-15">Account</th>
														<th class="bg-transparent border-bottom-0">Job / Scholarship</th>
														...
														<td>
															<div class="d-flex align-items-center">
																<div class="user-details ms-2">
																	...
																	<span class="text-muted fs-12">{{ $x->email }}</span>
																</div>
															</div>
														</td>
														<td class="text-muted fs-13"><a href="#!" class="text-dark">
															@if($x->is_job)
																{{ 'Job' }}
															@else
																{{ 'Scholarship' }}
