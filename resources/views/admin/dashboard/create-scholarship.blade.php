		...
		<div class="side-app">
			...
			<div class="main-container container-fluid">
				...
				<div class="page-header">
					<div>
						<h1 class="page-title">Create Scholarship</h1>
					</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
                        <form method="POST" action="{{ route('admin.create.scholarship') }}">
                            @csrf
                            <div  class="card">
                                    ...
                                    <div class="row p-5 border-bottom">
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="project-name" type="text" name="title" class="form-control text-dark" placeholder="Enter title">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3 end-date-container">
                                            <div class="form-group">
                                                <label for="project-end-date" class="form-label text-muted">Deadline:</label>
                                                <div id="pe-datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                                                    ...
                                                    <input id="project-end-date" name="deadline" class="form-control" type="text" placeholder="Select Deadline"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="project-name" type="text" name="award" required class="form-control text-dark" placeholder="Enter award value">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="project-name" type="text" name="link" class="form-control text-dark" placeholder="Paste link here">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            ...
                                            <!-- <div class="mb-3"> -->
											  ...
											  <textarea class="form-control " id="validationTextarea" placeholder="About this scholarship" name="about" rows="15" required></textarea>
