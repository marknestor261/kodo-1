	...
	<div class="app-sidebar">
		...
		<div class="main-sidemenu">
			...
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" data-active="{{ is_active_route(['matched']) }}" href="{{ route('matched') }}">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" data-active="{{ is_active_route(['saved']) }}" href="{{ route('saved') }}">
						<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" style="width:1.5rem !important;margin-top:8px;margin-right:2px" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" data-active="{{ is_active_route(['applied']) }}" href="{{ route('applied') }}">
						<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" style="width:1.5rem !important;margin-top:8px;margin-right:2px" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" data-active="{{ is_active_route(['banned']) }}" href="{{ route('banned') }}">
						<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" style="width:1.5rem !important;margin-top:8px;margin-right:2px" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
